<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="warga" id="warga" class="form-control @error('warga') is-invalid @enderror">
                ...
                <option value="{{ $wrg->id }}">({{ $wrg->nik }}) {{ $wrg->nama_warga }}</option>
                @endforeach
            </select>
            @error('warga')
            <div class="invalid-feedback">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="jenis" id="jenis" value="{{ $antrian->jenis ?? old('jenis') }}" class="form-control @error('jenis') is-invalid @enderror">
