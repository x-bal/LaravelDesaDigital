    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header d-flex flex-row justify-content-between">
                ...
                <a href="{{ route('desa.antrian.create') }}" class="btn btn-sm btn-primary">Create New</a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-striped" id="datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('desa.antrian.edit', $antrian->id) }}" class="btn btn-sm btn-success">Edit</a>
